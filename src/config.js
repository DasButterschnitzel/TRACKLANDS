...
export const WAGONS = {
  ...
  // Phase 6 stock: coaches by length and comfort, parcel and high-capacity
  // freight, specialised tanks/hoppers/flats; mu_car only runs between the
  // power cars of a multiple unit; double stacks are too tall for overhead wires
  short_coach: { len: 1.15, mass: 13, cap: 7, carries: ['PASSENGERS'], cost: 90, vmax: 100, cls: 'pax' },
  long_coach: { len: 1.75, mass: 24, cap: 14, carries: ['PASSENGERS'], cost: 260, vmax: 180, cls: 'pax', research: 'passenger_comfort' },
  sleeper: { len: 1.6, mass: 24, cap: 6, carries: ['PASSENGERS'], cost: 480, vmax: 180, cls: 'pax', research: 'passenger_comfort', longRev: 0.25 },
  dining: { len: 1.5, mass: 22, cap: 3, carries: ['PASSENGERS'], cost: 520, vmax: 180, cls: 'pax', research: 'passenger_comfort', trainRev: 0.06 },
  mu_car: { len: 1.5, mass: 16, cap: 12, carries: ['PASSENGERS'], cost: 300, vmax: 320, loadMul: 1.4, cls: 'pax', mu: true },
  parcel_van: { len: 1.4, mass: 16, cap: 12, carries: ['MAIL', 'GOODS', 'ELECTRONICS'], cost: 180, vmax: 160, cls: 'mail' },
  hc_boxcar: { len: 1.75, mass: 20, cap: 15, carries: ['FOOD', 'GOODS', 'MAIL', 'FRUIT', 'PAPER', 'ELECTRONICS', 'MATERIALS'], cost: 210, vmax: 120, cls: 'freight', research: 'heavy_haul' },
  open_wagon: { len: 1.3, mass: 14, cap: 10, carries: ['COAL', 'ORE', 'STONE', 'SAND', 'CLAY', 'COPPER', 'WOOD'], cost: 80, vmax: 100, cls: 'freight' },
  hc_hopper: { len: 1.6, mass: 22, cap: 17, carries: ['COAL', 'ORE', 'STONE', 'SAND', 'CLAY', 'COPPER', 'GRAIN'], cost: 230, vmax: 110, cls: 'freight', research: 'heavy_haul' },
  grain_hopper: { len: 1.4, mass: 16, cap: 13, carries: ['GRAIN'], cost: 150, vmax: 120, cls: 'freight', research: 'specialized_wagons' },
  chem_tank: { len: 1.3, mass: 18, cap: 11, carries: ['CHEMICALS', 'FUEL', 'OIL'], cost: 200, vmax: 110, cls: 'freight', research: 'specialized_wagons', revMul: 0.1 },
  double_stack: { len: 1.75, mass: 18, cap: 26, carries: ['GOODS', 'FOOD', 'ELECTRONICS', 'PAPER', 'FRUIT', 'FISH'], cost: 420, vmax: 130, cls: 'freight', research: 'containerization', tall: true },
  coil: { len: 1.25, mass: 18, cap: 12, carries: ['STEEL'], cost: 170, vmax: 110, cls: 'freight', research: 'specialized_wagons', revMul: 0.1 },
  cement: { len: 1.25, mass: 17, cap: 13, carries: ['MATERIALS'], cost: 160, vmax: 110, cls: 'freight', research: 'specialized_wagons' },
...
export const locoLen = (m) => m.len || LOCO_LEN[m.id] || (m.kind === 'hst' || m.kind === 'maglev' ? 2.0 : 1.8);
// research a model needs besides its level (a model may override its era's)
export const locoResearch = (m) => ('req' in m ? m.req : ERA_RESEARCH[m.era]) || null;
...
export const LOCOS = [
  ...
  { id: 'meadow_tank', name: 'Meadow Tank 2-4-2', era: 1, kind: 'steam', role: 'passenger', speed: 76, accel: 1.2, power: 520, freight: 6, pax: 26, wagons: 3, reliability: 0.92, load: 1.1, op: 30, price: 1800, rarity: 'common', trait: 'city_hopper', level: 5, color: 0x7a2f2f, duty: 'local', shape: 'tank' },
  { id: 'atlas', name: 'Atlas Heavy Steam', era: 2, kind: 'steam2', role: 'freight', speed: 88, accel: 0.75, power: 1100, freight: 34, pax: 8, wagons: 4, reliability: 0.9, load: 1.0, op: 55, price: 4800, rarity: 'uncommon', trait: 'cargo_master', level: 8, color: 0x2b2e33, duty: 'heavy', shape: 'heavy' },
  { id: 'silverline', name: 'Silverline Express', era: 2, kind: 'steam2', role: 'passenger', speed: 115, accel: 1.0, power: 900, freight: 8, pax: 40, wagons: 4, reliability: 0.93, load: 1.1, op: 60, price: 6500, rarity: 'rare', trait: 'express', level: 10, color: 0x8b99a8, duty: 'express', shape: 'stream' },
  { id: 'trailmaster', name: 'Trailmaster Diesel', era: 3, kind: 'diesel', role: 'mixed', speed: 110, accel: 1.3, power: 1500, freight: 32, pax: 30, wagons: 4, reliability: 0.96, load: 1.1, op: 80, price: 14000, rarity: 'common', trait: 'high_accel', level: 13, color: 0xd08a2e, duty: 'regional', shape: 'hood' },
  { id: 'cargoking', name: 'CargoKing D40', era: 3, kind: 'diesel', role: 'freight', speed: 105, accel: 1.0, power: 2200, freight: 56, pax: 0, wagons: 5, reliability: 0.95, load: 1.0, op: 95, price: 22000, rarity: 'uncommon', trait: 'heavy_freight', level: 16, color: 0x2f5f8a, duty: 'heavy', shape: 'cabfwd' },
  { id: 'metrorunner', name: 'MetroRunner D6', era: 3, kind: 'diesel', role: 'passenger', speed: 125, accel: 1.6, power: 1600, freight: 10, pax: 56, wagons: 4, reliability: 0.96, load: 1.3, op: 85, price: 26000, rarity: 'uncommon', trait: 'fast_loading', level: 18, color: 0xc8c1b0, duty: 'express', shape: 'cab' },
  { id: 'voltstream_e1', name: 'Voltstream E1', era: 4, kind: 'electric', role: 'mixed', speed: 150, accel: 1.8, power: 3000, freight: 48, pax: 48, wagons: 5, reliability: 0.97, load: 1.2, op: 90, price: 60000, rarity: 'uncommon', trait: 'cheap_op', level: 21, color: 0x2e8b7a, electric: true, duty: 'mixed', shape: 'box' },
  { id: 'voltstream_e3', name: 'Voltstream E3', era: 4, kind: 'electric', role: 'freight', speed: 165, accel: 1.6, power: 4200, freight: 80, pax: 0, wagons: 6, reliability: 0.97, load: 1.1, op: 120, price: 95000, rarity: 'rare', trait: 'cargo_master', level: 25, color: 0x8a2e2e, electric: true, duty: 'freight', shape: 'box3' },
  { id: 'falcon', name: 'InterCity Falcon', era: 4, kind: 'electric', role: 'passenger', speed: 190, accel: 1.9, power: 3600, freight: 12, pax: 90, wagons: 6, reliability: 0.97, load: 1.3, op: 125, price: 130000, rarity: 'rare', trait: 'long_hauler', level: 27, color: 0xe4e0d6, electric: true, duty: 'express', shape: 'sleek' },
  { id: 'arrowline_200', name: 'Arrowline 200', era: 5, kind: 'hst', role: 'passenger', speed: 250, accel: 2.2, power: 6000, freight: 0, pax: 120, wagons: 6, reliability: 0.98, load: 1.4, op: 200, price: 320000, rarity: 'rare', trait: 'express', level: 30, color: 0xf2f2f2, electric: true, duty: 'highspeed', shape: 'nose' },
  { id: 'arrowline_300', name: 'Arrowline 300', era: 5, kind: 'hst', role: 'passenger', speed: 300, accel: 2.4, power: 8000, freight: 0, pax: 150, wagons: 7, reliability: 0.98, load: 1.4, op: 260, price: 600000, rarity: 'epic', trait: 'long_hauler', level: 34, color: 0xe8eef2, electric: true, duty: 'highspeed', shape: 'longnose' },
  { id: 'novarail', name: 'NovaRail X', era: 5, kind: 'hst', role: 'freight', speed: 270, accel: 2.0, power: 9000, freight: 150, pax: 20, wagons: 7, reliability: 0.98, load: 1.3, op: 280, price: 750000, rarity: 'epic', trait: 'heavy_freight', level: 37, color: 0x3a3f58, electric: true, duty: 'freight', shape: 'freightnose', special: true },
  { id: 'vector_hst', name: 'Vector HST', era: 5, kind: 'hst', role: 'mixed', speed: 320, accel: 2.6, power: 10000, freight: 90, pax: 130, wagons: 7, reliability: 0.99, load: 1.5, op: 300, price: 1100000, rarity: 'epic', trait: 'fast_loading', level: 40, color: 0xd0402f, electric: true, duty: 'highspeed', shape: 'duck' },
  { id: 'magna_m1', name: 'MagnaRail M1', era: 6, kind: 'maglev', role: 'mixed', speed: 400, accel: 3.0, power: 14000, freight: 120, pax: 160, wagons: 7, reliability: 0.99, load: 1.6, op: 380, price: 2400000, rarity: 'legendary', trait: 'express', level: 44, color: 0x2fc4c0, electric: true, maglev: true, duty: 'highspeed', shape: 'maglev' },
  { id: 'magna_m3', name: 'MagnaRail M3', era: 6, kind: 'maglev', role: 'mixed', speed: 480, accel: 3.4, power: 18000, freight: 180, pax: 220, wagons: 8, reliability: 0.99, load: 1.8, op: 450, price: 4500000, rarity: 'legendary', trait: 'long_hauler', level: 48, color: 0x9a5cd6, electric: true, maglev: true, duty: 'highspeed', shape: 'needle' },
  // Phase 6 roster: every era offers a choice of duties (shunter … high speed),
  // multiple units carry passengers in the power car (mu) and run from
  // either end, 'req' overrides the era's research (null = none needed)
  { id: 'summit', name: 'Summit 2-10-0 Decapod', era: 2, kind: 'steam2', role: 'freight', speed: 80, accel: 0.85, power: 1250, freight: 30, pax: 10, wagons: 4, reliability: 0.9, load: 1.0, op: 60, price: 5200, rarity: 'uncommon', trait: 'mountain_goat', level: 7, color: 0x3b2f2a, duty: 'mountain', shape: 'decapod', len: 2.4 },
  { id: 'regent', name: 'Regent 4-6-0 Express', era: 2, kind: 'steam2', role: 'passenger', speed: 105, accel: 0.95, power: 1000, freight: 6, pax: 36, wagons: 5, reliability: 0.91, load: 1.0, op: 58, price: 5600, rarity: 'uncommon', trait: 'long_hauler', level: 9, color: 0x1f4a7a, duty: 'intercity', shape: 'pacific', len: 2.4 },
  { id: 'titan', name: 'Titan 2-6-6-0 Articulated', era: 2, kind: 'steam2', role: 'freight', speed: 70, accel: 0.6, power: 1500, freight: 44, pax: 0, wagons: 6, reliability: 0.87, load: 1.0, op: 72, price: 7200, rarity: 'rare', trait: 'heavy_freight', level: 11, color: 0x26282c, duty: 'heavy', shape: 'mallet', len: 2.7 },
  { id: 'yardmate', name: 'Yardmate S3 Shunter', era: 3, kind: 'diesel', role: 'mixed', speed: 60, accel: 1.1, power: 700, freight: 16, pax: 8, wagons: 3, reliability: 0.97, load: 1.2, op: 18, price: 5200, rarity: 'common', trait: 'cheap_op', level: 11, color: 0xd8b030, duty: 'shunter', shape: 'shunter', len: 1.3 },
  { id: 'valley_d2', name: 'Valley D2 Branch Diesel', era: 3, kind: 'diesel', role: 'mixed', speed: 95, accel: 1.4, power: 1100, freight: 18, pax: 26, wagons: 3, reliability: 0.95, load: 1.15, op: 55, price: 9800, rarity: 'common', trait: 'city_hopper', level: 12, color: 0x4a7a3a, duty: 'local', shape: 'center', len: 1.7 },
  { id: 'haulmaster', name: 'Haulmaster D30', era: 3, kind: 'diesel', role: 'freight', speed: 100, accel: 1.1, power: 1900, freight: 44, pax: 0, wagons: 5, reliability: 0.95, load: 1.05, op: 82, price: 17500, rarity: 'common', trait: 'cargo_master', level: 14, color: 0x7a2f2f, duty: 'freight', shape: 'hood2', len: 1.9 },
  { id: 'sprinter', name: 'Sprinter DMU', era: 3, kind: 'diesel', role: 'passenger', speed: 120, accel: 1.8, power: 1200, freight: 0, pax: 44, wagons: 3, reliability: 0.95, load: 1.4, op: 70, price: 19000, rarity: 'uncommon', trait: 'fast_loading', level: 15, color: 0x3f7ab8, duty: 'regional', shape: 'dmu', len: 1.6, mu: { cap: 12, carries: ['PASSENGERS'], loadMul: 1.4 } },
  { id: 'ampere', name: 'Ampere E0 Crocodile', era: 4, kind: 'electric', role: 'freight', speed: 110, accel: 1.3, power: 2400, freight: 44, pax: 20, wagons: 5, reliability: 0.94, load: 1.0, op: 70, price: 42000, rarity: 'uncommon', trait: 'mountain_goat', level: 20, color: 0x3a6a3a, electric: true, duty: 'mountain', shape: 'early', len: 2.2 },
  { id: 'citylink', name: 'CityLink EMU', era: 4, kind: 'electric', role: 'passenger', speed: 130, accel: 2.2, power: 2200, freight: 0, pax: 60, wagons: 3, reliability: 0.97, load: 1.5, op: 60, price: 52000, rarity: 'uncommon', trait: 'city_hopper', level: 22, color: 0xd8d8d0, electric: true, duty: 'local', shape: 'emu', len: 1.6, mu: { cap: 14, carries: ['PASSENGERS'], loadMul: 1.6 } },
  { id: 'thunder', name: 'Thunder D9', era: 4, req: null, kind: 'diesel', role: 'mixed', speed: 140, accel: 1.5, power: 3200, freight: 60, pax: 50, wagons: 6, reliability: 0.96, load: 1.1, op: 130, price: 70000, rarity: 'rare', trait: 'high_accel', level: 23, color: 0x3a3a3f, duty: 'mixed', shape: 'late', len: 2.0 },
  { id: 'mailstar', name: 'Mailstar Parcel Unit', era: 4, kind: 'electric', role: 'freight', speed: 170, accel: 2.0, power: 3000, freight: 30, pax: 0, wagons: 4, reliability: 0.97, load: 1.6, op: 90, price: 85000, rarity: 'rare', trait: 'express', level: 24, color: 0xc0392b, electric: true, duty: 'express', shape: 'parcel', len: 1.7, special: true, mu: { cap: 16, carries: ['MAIL', 'GOODS', 'ELECTRONICS'], loadMul: 1.5 } },
  { id: 'goliath', name: 'Goliath HH6 Heavy Haul', era: 4, req: 'heavy_haul', kind: 'diesel', role: 'freight', speed: 100, accel: 0.9, power: 5200, freight: 110, pax: 0, wagons: 8, reliability: 0.95, load: 1.0, op: 170, price: 110000, rarity: 'epic', trait: 'heavy_freight', level: 26, color: 0xc8a030, duty: 'heavy', shape: 'twin', len: 2.4, special: true },
  { id: 'meridian', name: 'Meridian Intercity EMU', era: 4, kind: 'electric', role: 'passenger', speed: 200, accel: 2.0, power: 4400, freight: 0, pax: 84, wagons: 5, reliability: 0.97, load: 1.35, op: 120, price: 150000, rarity: 'rare', trait: 'long_hauler', level: 28, color: 0xe8e4dc, electric: true, duty: 'intercity', shape: 'icemu', len: 1.9, mu: { cap: 14, carries: ['PASSENGERS'], loadMul: 1.3 } },
  { id: 'ironvolt', name: 'Ironvolt E9 Twin', era: 4, kind: 'electric', role: 'freight', speed: 140, accel: 1.3, power: 6400, freight: 120, pax: 0, wagons: 8, reliability: 0.96, load: 1.0, op: 150, price: 150000, rarity: 'epic', trait: 'heavy_freight', level: 29, color: 0x2e4a6a, electric: true, duty: 'heavy', shape: 'twin_e', len: 2.5 },
  { id: 'regiolink', name: 'RegioLink EMU', era: 4, kind: 'electric', role: 'passenger', speed: 160, accel: 2.4, power: 3000, freight: 0, pax: 64, wagons: 4, reliability: 0.98, load: 1.5, op: 80, price: 90000, rarity: 'rare', trait: 'fast_loading', level: 31, color: 0x2fa36a, electric: true, duty: 'regional', shape: 'regio', len: 1.7, mu: { cap: 16, carries: ['PASSENGERS'], loadMul: 1.6 } },
